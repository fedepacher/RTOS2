...
* @include qmp_use.c
*/
static void QMPool_put_ex( QMPool * const me, void *b )
{
...
void QMPool_put_FROM_ISR( QMPool * const me, void *b )
{
    ...
    */
	...
	uxSavedInterrumptStatus = taskENTER_CRITICAL_FROM_ISR(); //Enter on critical section

    QMPool_put_ex(me, b);

    taskEXIT_CRITICAL_FROM_ISR( uxSavedInterrumptStatus ); //Exit from critical section
}
...
* @include qmp_use.c
*/
void *QMPool_get_FROM_ISR( QMPool * const me, unsigned short const margin )
{
    QFreeBlock *fb;
    UBaseType_t uxSavedInterrumptStatus;
